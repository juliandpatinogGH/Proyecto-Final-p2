...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // ── 1. SINGLETON: Model.GestionEventos ─────────────────────────
        System.out.println("--- [Singleton] Model.GestionEventos ---");
        ...
        System.out.println("\n--- [Decorator] Model.Entrada con servicios adicionales ---");
        ...
        // ── 4. BUILDER: Construir una Model.Compra paso a paso ──────────
        ...
        System.out.println("Model.Compra creada. Total: $" + compra.getTotal());
        ...
        System.out.println("\n--- [Facade] Model.ProcesoPagoFacade ---");
        ...
        System.out.println("Model.Compra original  id: " + compra2.getIdCompra());
        System.out.println("Model.Compra clonada   id: " + compraClonada.getIdCompra());
